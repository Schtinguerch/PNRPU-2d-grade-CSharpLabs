...
namespace LaboratoryWorkNo12
{
    public static class TrainCarCreator
    {
        ...
        private static GenerateCarMethod[] GarsInputs = new GenerateCarMethod[]
        {
            NewUserInputLocomotive,
            NewUserKitchenCar,
            NewUserEconomClassCar,
            NewUserCompartmentalClassCar,
        };
        ...
        public static Locomotive NewRandomLocomotive() =>
            new Locomotive(
                mass: _random.Next(1, 1000),
                length: _random.Next(1, 1000),
        ...
        public static void Repeat(this System.Action action, int count)
        {
            for (int i = 0; i < count; i++)
                action();
        }
